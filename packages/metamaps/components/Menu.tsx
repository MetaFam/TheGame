    ...
    return (
      <MenuContainer
        style={{
          ...
          top: menuY,
          opacity: menu ? 1 : 0,
          pointerEvents: menu ? 'inherit' : 'none',
        }}
      >
    ...
    return (
      ...
      >
        <input
          ...
          value={urlText}
          onChange={(e) =>
            dispatch({ type: 'UPDATE_URL_TEXT', value: e.target.value })
          }
        />
        <ButtonGroup spacing={4}>
          <Button
    ...
    return (
      ...
      >
        <textarea
          ...
          value={popupText}
          onChange={(e) =>
            dispatch({ type: 'UPDATE_POPUP_TEXT', value: e.target.value })
          }
        />
        <ButtonGroup spacing={4}>
          <Button
...
export const Menu = connect((state: any) => ({
  menu: state.menu,
