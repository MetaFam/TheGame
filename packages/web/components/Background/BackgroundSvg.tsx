...
const PageBackgroundSvg = () => (
    <SVG width="3090" height="2002" viewBox="0 0 3090 2002" fill="none" xmlns="http://www.w3.org/2000/svg" sx={{
      ...
      <g clip-path="url(#clip0_9532_11889)">
        ...
        <g filter="url(#filter0_b_9532_11889)">
          <rect width="3452" height="2002" fill="#080219" fill-opacity="0.6" />
        </g>
      </g>
      <defs>
        <filter id="filter0_b_9532_11889" x="-721.8" y="-721.8" width="4895.6" height="3445.6" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
        ...
        <linearGradient id="paint0_linear_9532_11889" x1="778.951" y1="1353.71" x2="512.96" y2="598.088" gradientUnits="userSpaceOnUse">
          <stop stop-color="#500A7C" />
          <stop offset="1" stop-color="#500A7C" stop-opacity="0" />
        </linearGradient>
        <linearGradient id="paint1_linear_9532_11889" x1="3001.34" y1="1165.32" x2="2255.01" y2="16.6449" gradientUnits="userSpaceOnUse">
          <stop stop-color="#2A0D7D" />
          <stop offset="1" stop-color="#2A0D7D" stop-opacity="0" />
        </linearGradient>
