      ...
      <Flex direction="column">
        ...
        <Flex justify="end">
          ...
          >
            ...
            sustainability strategies. If you want to dig deeper, it might be
            best to dig down the raids section & ask some questions or read the
            Purplepaper 🙃
          </Text>
        </Flex>
        ...
        <Flex justify="end">
          <Text
            ...
            mr={5}
          >
            We prefer our patrons inrinsically motivated, so the main reason
            you'd want to become a patron is just the fact you love this whole
            idea of MetaGame & want to see it succeed. If you weren’t so damn
            busy, you’d probably join in on building it, but at this point, its
            easier for you to just pitch in a bucket of water & support the
            movement passively.
          </Text>
        </Flex>
