...
const PatronsPage: React.FC<Props> = ({ patrons, pSeedPrice }) => {
  ...
  return (
    <PageContainer>
      ...
      {/* VStack is used to make a consistent gap between the Patrons CTA, the Patrons list, the Load More button, the X of Y patrons text, and the Octo image and back to top link */}
