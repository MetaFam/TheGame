...
You can [check your XP here](https://metafam.github.io/XP/#/explorer), but don’t get attached to the number. Because XP is earned via contributions and engagement, which are always fluctuating; XP scores are always fluctuating. They are not fixed.
